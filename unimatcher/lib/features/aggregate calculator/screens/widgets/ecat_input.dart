...
import 'package:unimatcher/features/aggregate%20calculator/controllers/ecat_controller.dart';
import 'package:unimatcher/utils/constants/colors.dart';
import 'package:unimatcher/utils/constants/image_strings.dart';
import 'package:unimatcher/utils/constants/sizes.dart';

class EcatInput extends StatelessWidget {
  final EcatController _controller = Get.put(EcatController());

  EcatInput({Key? key}) : super(key: key);
